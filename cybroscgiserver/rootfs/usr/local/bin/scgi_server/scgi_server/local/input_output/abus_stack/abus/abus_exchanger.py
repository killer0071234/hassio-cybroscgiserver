...
class AbusExchanger:
    ...
    def __init__(self,
        ...
        asyncio.set_event_loop(loop=self._communication_loop)
        ...
        self._last_exchange_tag: tuple[int, int, int] | None = None

        # pending response for the request which has just been pulled from
        # queue and sent
        self._current_pending_response: Future[AbusMessage] | None = None
    ...
    async def exchange_threadsafe(self,
                                  request: AbusMessage) -> AbusMessage:
    ...
    @staticmethod
    def _extract_exchange_tag_from_request(abus_request: AbusMessage
                                           ) -> tuple[int, int, int]:
    ...
    @staticmethod
    def _extract_exchange_tag_from_response(abus_response: AbusMessage
                                            ) -> tuple[int, int, int]:
