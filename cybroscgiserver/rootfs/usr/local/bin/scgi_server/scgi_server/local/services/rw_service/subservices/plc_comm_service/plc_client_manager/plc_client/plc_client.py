...
class PlcClient:
    ...
    @property
    def _addr(self) -> tuple[str | None, int]:
    ...
    async def read_random_memory(
        ...
        params_left: tuple[list[int], list[int], list[int], list[int]] | None
    ...
    async def write_random_memory(
        ...
        two_b_values: list[int | float | None],
        four_b_values: list[int | float | None],
        ...
        params_to_use: tuple[
            ...
            list[int], list[int | float | None], list[int | float | None],
            list[DataType]
        ]
        params_left: tuple[
            list[int], list[int], list[int],
