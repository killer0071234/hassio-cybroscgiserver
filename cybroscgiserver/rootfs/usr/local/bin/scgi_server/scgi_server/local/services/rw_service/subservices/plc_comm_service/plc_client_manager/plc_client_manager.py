...
class PlcClientManager:
    def __init__(
        ...
        self._plc_clients_by_nad: dict[int, Future[PlcClient]] = {}
        self._cpu_intensive_task_runner: CPUIntensiveTaskRunner = (
            cpu_intensive_task_runner
        )

        self._exchanger: AbusExchanger | None = None
    ...
    async def get(self, nad: int) -> PlcClient | None:
        try:
            try:
    ...
    def _set(self, nad: int, plc_client: PlcClient | None) -> None:
        try:
