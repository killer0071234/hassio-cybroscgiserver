...
class IexCommand:
    ...
    @property
    def is_abus(self) -> bool:
        return self.arg == 0b010

    @property
    def is_strend(self) -> bool:
    ...
    @staticmethod
    def iex_command_to_int(iex_command: 'IexCommand') -> int:
    ...
    @staticmethod
    def bytes_to_iex_command(iex_command: bytes) -> 'IexCommand':
    ...
    @staticmethod
    def create_abus_stream_outgoing() -> 'IexCommand':
        return IexCommand(instruction=0b1010,
                          direction=0b1,
                          arg=0b010)

    @staticmethod
    def create_abus_strend_outgoing() -> 'IexCommand':
...
class IexFrame:
    ...
    @classmethod
    def iex_to_bytes(cls, iex_frame: 'IexFrame') -> tuple[bytes, bytes]:
    ...
    @classmethod
    def bytes_to_iex(cls,
                     iex_header_bytes: bytes,
                     iex_data_bytes: bytes) -> 'IexFrame':
    ...
    @staticmethod
    def create_abus_stream_out(address: int, data: bytes) -> 'IexFrame':
    ...
    @staticmethod
    def create_abus_strend_out(address: int, data: bytes) -> 'IexFrame':
    ...
    @property
    def is_data_abus_start(self) -> bool:
